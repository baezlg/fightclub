    ...
    <section className="text-white">
      <Container>
        ...
        <p className="display-6">
          ...
          from you or that you may provide when you visit https://fightclub.com
          or https://ondemand.fightclub.com (our "Website") and our practices
        ...
        <ul className="display-6 mb-5 fs-2">
        ...
        <p className="display-6">
          Our Website is not intended for persons under eighteen (18) years of
          age. No one under the age of eighteen (18) may provide any personal
          information to or on the Website. We do not knowingly collect personal
          information from persons under eighteen (18). If you are under
          eighteen (18), do not use or provide any information on this Website
          or through any of its features, register on the Website, make any
          ...
          eighteen (18) without verification of parental consent, we will delete
          that information. If you believe we might have any information from or
          about a person under eighteen (18), please contact us at
          techsupport@fightclub.com. California residents under sixteen (16)
          years of age may have additional rights regarding the collection and
          sale of their personal information.
        </p>
        <h3 className="fw-bold my-5 text-danger">
        ...
        <h3 className="fw-bold my-4 text-danger">Contact Information</h3>
        <p className="display-6">
          To ask questions or comment about this privacy policy and our privacy
          practices, contact us at:
          <br />
          123 main str, tallinn or techsupport@fightclub.com.
        </p>
      </Container>
    </section>
  );
